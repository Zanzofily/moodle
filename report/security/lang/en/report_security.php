...
$string['check_displayerrors_details'] = 'Enabling the php setting <code>display_errors</code> is not recommended on production sites because some error messages may reveal sensitive information about your server.';
...
$string['check_debugging_name'] = 'Error Debugging';
$string['check_debugging_error'] = 'Error debugging setting is enabled. It is recommended that this is disabled in production.';
$string['check_debugging_ok'] = 'Error debugging disabled.';
